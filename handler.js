    ...
    case 'remove':
      if (chat.welcome && !chat?.isBanned) {
        ...
        for (const user of participants) {
          let pp = 'https://telegra.ph/file/e5c15ace1bbfb0fc11439.jpg';
          try {
...
global.dfail = (type, m, conn) => {
  ...
  const msg = {
    rowner: '*↞هذا الامر للمطور فقط✓┃⛔️┃*',
      owner: '*↞هذا الامر للمطور فقط✓┃⛔️┃*',
      mods: '*↞ الميزه هذي لمالك فقط✓┃⛔️┃*',
      premium: '*↞الميزه هذي للأعضاء المميزين فقط✓┃⛔️┃*',
      group: '*↞هذا الامر  في القروبات فقط✓┃⛔️┃*',
      private: '*↞الميزه هذي في الخاص  فقط✓┃⛔️┃*',
      admin: '*↞ هذا الأمر للادمن فقط✓┃⛔️┃┊*',
      botAdmin: '*↞ارفع البوت ادمن عشان تستخدم الامر✓┃⛔️┃*',
      unreg: '*[ لحظة !! انت مو مسجل ]*\n\n*『 سجل الامر عشان تفعله 』*\n*➣ #تفعيل الاسم.السن*\n*➣مثل : #تفعيل ارثر.17*',
